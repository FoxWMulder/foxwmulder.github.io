...
![mklink утилита для создания симлинков в windows](_attachments/Pasted%20image-2025-09-05%2017-33-21-427.png)
...
![параметр групповой политики Create Symbolic Links](_attachments/Pasted%20image-2025-09-05%2017-33-21-704.png)
...
![пример использования mklink для создание символьных ссылок в windows](_attachments/Pasted%20image-2025-09-05%2017-33-21-947.png)

Теперь при переходе в каталог C:\PS\Downloads вы будете видеть содержимое каталога, на который он ссылается.

![символическая ссылка на каталог в windows](_attachments/Pasted%20image-2025-09-05%2017-33-22-227.png)

Выведем содержимое каталога C:\PS:

`Dir c:\ps`

Как вы видите, в атрибутах некоторых файлов указано, что это symlink/simlinkd. Также указан объект, на который они ссылаются. В Windows File Explorer симлинки отображаются с иконками ярлыков, а в их свойствах можно посмотреть целевой объект на который они ссылаются.![Dir вывести информацию о всех symlink в папке](_attachments/Pasted%20image-2025-09-05%2017-33-22-452.png)
...
![создать SymbolicLink с помощью powershell](_attachments/Pasted%20image-2025-09-05%2017-33-22-721.png)
...
![fsutil behavior query SymlinkEvaluation](_attachments/Pasted%20image-2025-09-05%2017-33-22-947.png)
...
![вывести все симлинке на диске в windows](_attachments/Pasted%20image-2025-09-05%2017-33-23-237.png)
